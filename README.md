...
Java 後端工程師，5 年開發經驗，主要在做 FinTech 相關的專案。

職涯是從台灣美光的設備工程師開始的。在產線第一線排機台異常的時候，
發現軟體工具對 troubleshooting 的幫助很大，後來就轉去寫程式了。
...
- **要練能力的專案** — 核心邏輯自己寫，AI 的產出逐段 review
- **要產出東西的專案** — 讓 AI 主導實作，我負責定義需求跟驗收結果
